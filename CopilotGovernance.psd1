@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'v0.2.0 - Get-OversharedContent (finds Anonymous/Organization sharing links via the scalable SharingLinks-groups method) and Invoke-CopilotReadinessAssessment (produces a branded HTML Copilot Readiness Scorecard). v0.1.0 - Get-EveryoneAccess.'
        }
    }
}
